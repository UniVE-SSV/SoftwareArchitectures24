...
<div class="lesson-nav">
    <div>
        Previous: <a href="/SoftwareArchitectures24/gradle/build.gradle">Gradle - build.gradle</a>
    </div>
    <div>
        Next: <a href="/SoftwareArchitectures24/gradle/example-log4j">Gradle - Example: log4j</a>  
    </div>
</div>